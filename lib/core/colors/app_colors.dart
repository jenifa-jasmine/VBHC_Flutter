...
class AppColors {
  // =====================
  // VBHC BRAND COLORS (உங்க Colors.js-ல இருந்து)
  // =====================
...
// =====================
// getColors() - உங்க RN getColors(isDarkTheme) exact match
// =====================
class VBHCColors {
  final bool isDark;
  ...
  // Getters - exact same names as your RN Colors.js
  Color get statusBarColor        => isDark ? AppColors.darkStatusBar        : AppColors.lightStatusBar;
  Color get actionBarColor        => isDark ? AppColors.darkActionBar        : AppColors.lightActionBar;
  Color get actionBarTextColor    => isDark ? AppColors.darkActionBarText    : AppColors.lightActionBarText;
  Color get actionBarIconColor    => isDark ? AppColors.darkActionBarIcon    : AppColors.lightActionBarIcon;
  Color get appScreenColor        => isDark ? AppColors.darkBackground       : AppColors.lightBackground;
  Color get bottomNavBarColor     => isDark ? AppColors.darkBottomNav        : AppColors.lightBottomNav;
  Color get activeBackgroundColor => isDark ? AppColors.darkActiveNavBg      : AppColors.lightActiveNavBg;
  Color get activeIconColor       => isDark ? AppColors.darkActiveNavIcon    : AppColors.lightActiveNavIcon;
  Color get inActiveIconColor     => isDark ? AppColors.darkInactiveNavIcon  : AppColors.lightInactiveNavIcon;
  Color get textInputBackground   => isDark ? AppColors.darkInputBg          : AppColors.lightInputBg;
  Color get textInputBorderColor  => isDark ? AppColors.darkInputBorder      : AppColors.lightInputBorder;
  Color get textInputPlaceholder  => isDark ? AppColors.darkInputPlaceholder : AppColors.lightInputPlaceholder;
  Color get textInputTextColor    => isDark ? AppColors.darkInputText        : AppColors.lightInputText;
  Color get textBlack             => isDark ? AppColors.darkTextBlack        : AppColors.lightTextBlack;
  Color get textWhite             => AppColors.lightTextWhite;
  Color get textGray              => isDark ? AppColors.darkTextGray         : AppColors.lightTextGray;
  Color get textGreen             => isDark ? AppColors.darkTextGreen        : AppColors.lightTextGreen;
  Color get textBlue              => isDark ? AppColors.darkTextBlue         : AppColors.lightTextBlue;
  Color get borderColor           => isDark ? AppColors.darkBorder           : AppColors.lightBorder;
  Color get textLine              => isDark ? AppColors.darkTextLine         : AppColors.lightTextLine;
  Color get textLabelTitle        => isDark ? AppColors.darkLabelTitle       : AppColors.lightLabelTitle;
  Color get textLabelColor        => isDark ? AppColors.darkLabelColor       : AppColors.lightLabelColor;
  Color get primaryButtonColor    => isDark ? AppColors.darkStatusGreen      : AppColors.lightStatusGreen;
  Color get backgroundWhite       => isDark ? AppColors.darkBgWhite          : AppColors.lightBgWhite;
  Color get backgroundBlue        => isDark ? AppColors.darkActiveNavBg      : AppColors.lightActiveNavBg;
  Color get backgroundGray        => isDark ? AppColors.darkBgGray           : AppColors.lightBgGray;
  Color get editBackgroundColor   => isDark ? AppColors.darkEditBg           : AppColors.lightEditBg;
  Color get disabledBackground    => isDark ? AppColors.darkDisabledBg       : AppColors.lightDisabledBg;
  Color get statusGreen           => isDark ? AppColors.darkStatusGreen      : AppColors.lightStatusGreen;
  Color get statusYellow          => isDark ? AppColors.darkStatusYellow     : AppColors.lightStatusYellow;
  Color get statusRed             => isDark ? AppColors.darkStatusRed        : AppColors.lightStatusRed;
  Color get emptyDataTitle        => isDark ? AppColors.darkEmptyTitle       : AppColors.lightEmptyTitle;
  Color get emptyDataText         => isDark ? AppColors.darkEmptyText        : AppColors.lightEmptyText;
}